...
2._ No necesita de la creacion de una base de datos, el archivo utiliza sqllite por lo que ya viene integrado
y se creara una carpeta llamada data al ejecutar, alli vendran las bases de datos.
